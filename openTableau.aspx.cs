    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["TBview"] != null && Request.QueryString["Site"] != null)
        {
            ...
            if (responseString.ToString() != "-1")
            {
                ...
                //Response.Redirect("https://vmprdtableau01.bst.co.th/trusted/" + responseString + "/t/" + Request.QueryString["Site"].ToString()+"/"+Request.QueryString["TBview"].ToString() + "?iframeSizedToWindow=true&:embed=y&:showAppBanner=false&:display_count=no&:showVizHome=no#5");
            }
        }
        else
        {
