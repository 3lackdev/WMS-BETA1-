<%@ Page Title="" Language="C#"  ValidateRequest="false" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="updatetemplate.aspx.cs" Inherits="template" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
          ...
          <asp:View ID="View2" runat="server">
              ...
              <br />
              <asp:Label ID="Label1" runat="server" Text="Temaplate RowID : "></asp:Label><asp:Label ID="rowid_txt" runat="server" Text="Label"></asp:Label>
            ...
            StyleWithCSS="True" EnableStripStyleTagsCodeInjection="False" Height="700px" 
             ...
             &nbsp;<br />
              <asp:Button ID="btn_save" runat="server" onclick="btn_save_Click" Text="Save" 
                  Width="113px" onclientclick="return checkdup();" />
              &nbsp;&nbsp;&nbsp;
